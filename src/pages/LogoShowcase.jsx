...
function ConceptCard({ concept, isSelected, onSelect }) {
  ...
  return (
    <motion.div
      ...
      style={{
        cursor: 'pointer',
        border: isSelected ? '2px solid #6B1F1F' : '2px solid #E8E0D6',
        borderRadius: 16,
        overflow: 'hidden',
    ...
    >
      ...
      <div style={{
        ...
        <Mark
          ...
          accent={concept.id === 'orbit' ? '#6B1F1F' : '#6B1F1F'}
      ...
      <div style={{ padding: '28px 28px 32px' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          {isSelected && (
            <span style={{
              ...
              textTransform: 'uppercase', color: '#6B1F1F',
              background: 'rgba(107,31,31,0.1)', padding: '3px 10px', borderRadius: 980,
            }}>
              Selected
            </span>
          )}
        ...
        <div style={{ background: 'rgba(107,31,31,0.06)', borderLeft: '3px solid #6B1F1F', padding: '10px 14px', borderRadius: '0 6px 6px 0' }}>
      ...
      <section style={{ padding: '72px 5vw 48px', maxWidth: 960, margin: '0 auto' }}>
        <motion.span
          ...
          style={{ display: 'block', fontSize: 11, fontWeight: 600, letterSpacing: '0.18em',
            textTransform: 'uppercase', color: '#6B1F1F', marginBottom: 16 }}
        >
          Identity System
        </motion.span>
        <motion.h1
